          ...
          <div class="col-lg-4">
            ...
            <h3>Spesifikasi Bangunan</h3>
              <ul>
                ...
                <li><strong>Pondasi</strong>: Pondasi menerus batu kali (diperkuat)</li>
                <li><strong>Dinding</strong>: Pasangan bata di plester + Finishing cat , Kalsiboard sintetic</li>
                <li><strong>Finishing Lantai</strong>: GRANIT 60x60</li>
                <li><strong>Atap</strong>: Rangka Galvalum, penutup genteng dicat</li>
                <li><strong>Plafon</strong>: Rangka hallow, Penutup gypsumboard</li>
                <li><strong>Finishing Kusen</strong>: alumiunium brown 4derajat</li>
                <li><strong>Daun Pintu Jendela</strong>: Pintu Utama - Panel finishing cat duco, Pintu Kamar - Panel finish cat, Pintu KM/WC - PVC</li>
                <li><strong>Sanitar</strong>: Kloset duduk Ex.American Standart, Shower, Lantai KM keramik 20/20, Dinding 20x25</li>
