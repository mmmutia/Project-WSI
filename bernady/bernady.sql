...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 02, 2023 at 07:23 PM
...
(5, 20, '2022-12-30', 'WIN_20221227_07_30_04_Pro.jpg', 'Lunas');
...
(8, 24, '2023-01-02', 'WhatsApp Image 2022-12-28 at 08.29.30.jpeg', '');
...
--
ALTER TABLE `pembayaran_dp`
  MODIFY `id_pembayaran_dp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT for table `pembayaran_inhouse`
--
ALTER TABLE `pembayaran_inhouse`
  MODIFY `id_pembayaran_inhouse` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `simpan_cluster`
  MODIFY `id_simpan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=75;
